...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_api_providers_user_id"), "api_providers", ["user_id"], unique=False
    )
    op.create_table(
        "companies",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_searches_company_id"), "searches", ["company_id"], unique=False
    )
    op.create_index(
        op.f("ix_searches_created_at"), "searches", ["created_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_hr_contacts_company_id"), "hr_contacts", ["company_id"], unique=False
    )
    op.create_index(
        op.f("ix_hr_contacts_contact_category"),
        "hr_contacts",
        ["contact_category"],
        unique=False,
    )
    op.create_index(
        op.f("ix_hr_contacts_created_at"), "hr_contacts", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_hr_contacts_search_id"), "hr_contacts", ["search_id"], unique=False
    )
    op.create_index(
        op.f("ix_hr_contacts_user_id"), "hr_contacts", ["user_id"], unique=False
    )
    op.create_table(
        "search_logs",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_search_logs_created_at"), "search_logs", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_search_logs_search_id"), "search_logs", ["search_id"], unique=False
    )
