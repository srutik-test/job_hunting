...
class JobCreate(BaseModel):
    ...
    crawler_engine: Optional[str] = Field(
        default="auto",
        description="Crawler preference: auto, aiohttp, firecrawl, playwright",
    )
    enable_public_search: bool = Field(
        default=True, description="Search public business directories and indexes"
    )
