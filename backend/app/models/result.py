...
class ExtractionResult(Base):
    ...
    recruitment_email = Column(String(255), nullable=True, default="Not Publicly Available")
    ...
    linkedin_profile_url = Column(String(1024), nullable=True, default="Not Publicly Available")
    ...
    def to_dict(self):
        try:
            raw_details = json.loads(self.raw_details_json) if self.raw_details_json else {}
        except Exception:
            raw_details = {}
        ...
        return {
            ...
            "linkedin_profile_url": self.linkedin_profile_url or "Not Publicly Available",
