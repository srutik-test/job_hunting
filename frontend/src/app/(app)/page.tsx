...
const STATS = [
  ...
  },
  {
    ...
    label: "Verified HR contacts",
    Icon: CheckCircle2,
    tint: "text-emerald-500",
  },
  {
    key: "possible_contacts",
    label: "Possible HR contacts",
    Icon: Mail,
    tint: "text-amber-500",
  },
  {
    key: "company_emails",
    label: "Company emails found",
    Icon: Table2,
    tint: "text-slate-500",
  },
  {
    key: "linkedin_profiles",
    label: "HR profiles found",
    Icon: Users,
    tint: "text-sky-500",
  },
  {
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    api
      .listSearches()
      .then((s) => setSearches(s.slice(0, 6)))
      .catch(() => {});
