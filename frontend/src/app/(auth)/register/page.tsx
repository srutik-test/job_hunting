    ...
    >
      <div className="space-y-3 mb-5">
        <button
          ...
          className="w-full inline-flex items-center justify-center space-x-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 shadow-sm transition"
        >
